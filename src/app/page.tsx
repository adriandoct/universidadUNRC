      ...
      <div className="text-center max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight leading-none text-white">
            ...
            y Base de Datos <span className="bg-gradient-to-r from-amber-300 via-emerald-400 to-amber-200 bg-clip-text text-transparent">Supabase UNRC</span>
          </h1>
          
          <p className="text-gray-300 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
            Plataforma institucional para **Alumnos, Docentes y Administrador**. Autenticación con **Gmail** (`@rcellanos.cdmx.gob.mx`) y consola para carga de datos en **Supabase**.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
        ...
        <div className="glass-panel p-8 rounded-3xl relative overflow-hidden group hover:border-amber-500/40 transition-all duration-300 flex flex-col justify-between space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-xs leading-relaxed">
              Consola especializada de **gestión y carga de Base de Datos para Supabase**. Sube archivos de Excel (`.xlsx`), CSV y JSON para realizar migraciones y sincronizaciones de tablas en tiempo real.
            </p>
          </div>
